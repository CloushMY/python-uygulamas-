...
class ResimDuzenleyici:
    def __init__(self):
        ...
        self.guncel_resim = None #Başlangıç değeri yok
    ...
    def arayuz_olustur(self):
        ...
        self.sol_panel.pack(expand=True) #Sol panel açık olarak gelmesi için

        self.resim_alani = ttk.Label(self.pencere)
        self.resim_alani.pack(expand=True)
        self.resim_alani.bind("<Button-1>", self.yazi_ekle_tikla) #Buton gibi düşünüp mause neredeyse ona göre yaziekletikla çalışır
        ...
        self.resim_sec_buton.pack(padx=5)
